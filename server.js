// server.js
// Xoris exoterika dependencies, mono Node builtins.
...
if (!playerId) return sendJSON(res, 400, { error: "playerId apaiteitai" });
...
if (!player) return sendJSON(res, 404, { error: "Agnostos paiktis" });
...
return sendJSON(res, 400, { error: "fromId, toId, liked (boolean) apaitountai" });
}
return sendJSON(res, 200, swipeModule.swipe(fromId, toId, liked));
}

if (pathname.startsWith("/api/")) {
return sendJSON(res, 404, { error: "Agnosto endpoint" });
}
